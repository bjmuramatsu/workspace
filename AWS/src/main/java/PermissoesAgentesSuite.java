...
public class PermissoesAgentesSuite {
	...
	public static void beforeClass() throws InterruptedException {
		PerfisPage.loginAsAgente("qa", "6110", "2522");
	}
	...
	// Teste para exebição de células para agentes (logar como agente)
	@Test()
	...
	// Teste para exibição de chamadas para agentes (logar como agente)
	@Test()
	...
	// Teste para exibição de operações para agentes (logar como agente)
	@Test()
	...
	// Teste para exibição de usuários para agentes (logar como agente)
	@Test()
	@Ignore
	...
	// Teste para exibição de relatórios para agentes (logar como agente)
	@Test()
	...
	// Teste para exibição de configurações de CTI para agentes (logar como agente)
	@Test()
	...
	// Teste para exibição de configurações gerais para agentes (logar como agente)
	@Test()
	...
	// Teste para exibição de motivos de pausa para agentes (Logar como agente)
	@Test()
